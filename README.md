...
This is my attempt to redesign a car dashboard. I think that the speedometer should be the most visible part of the dashboard because it is the most used. Next, I think vital information should be near that. I tried to also make the design look as appealing as possible while also being intuitive. To accomplish that, I made a "meter" design for the fuel gauge and engine temperature gauge on either side. I like this design because it is intuitive to me, although not everyone may think this. To me, it's like how liquid fills up a cup, the gas will fill up the meter. I find it easier to read whenever I'm driving, since my car has a fuel gauge and engine temperature gauge similar to this one. Next, I made most of the indicator lights standard and i grouped them all in one place. Although they look cluttered in the demonstration, not all the lights would ever be on the at the same time, so it's really not that bad. I put usage indictors, such as the cruise control and headlights above the warning indicators. This filled in a bit of empty space up there and also seemed to be cohesive with the rest of the design.
My main attempt here was to make the dashboard intuitive, easy to read, and also visually appealing. While my demonstration does lack a bit in some areas in terms of usage (I broke my program while trying to accomplish some implementations, causing it to be a bit incomplete) I do believe that the design accomplishes what I was attempting to do.
